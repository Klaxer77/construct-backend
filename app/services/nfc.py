...
from app.exceptions.nfc import NFCNotFoundExc, ObjectNFCUidIsExistsExc
...
class NFCService:
    ...
    async def verify_nfc(
        ...
        async with uow:
            ...
            access_expires_at = datetime.now(UTC) + timedelta(hours=8)
    ...
    async def create(
        ...
        async with uow:
            ...
            await uow.commit()
            return SNFCADD.model_validate({"access_expires_at": access_expires_at})